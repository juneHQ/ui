import{j as e}from"./MagnifyingGlassIcon-BBt5mED7.js";/* empty css               */import{A as l,Y as x,X as u,T as m,D as y,R as f,c as h,C as v,d as A,e as j,f as C}from"./index-JjUC-xdN.js";import{C as b,d as g,b as L,c as P,a as D}from"./constants-Bk89MV9n.js";import"./index-ColZRcxE.js";import"./index-BtbQ8gze.js";import{d as T}from"./constants-BMZGGsUz.js";import"./index-CEThVCg_.js";import"./index-xnkZ--kd.js";import"./mapValues-DsbhD-jO.js";import"./throttle-SSwQpIvp.js";import"./isPlainObject-CUX78SmW.js";import"./tiny-invariant-CopsF_GD.js";import"./_baseUniq-DyUJG2DD.js";const K={type:"monotone",stroke:"inherit",strokeWidth:1.5,fill:"inherit",activeDot:{r:5},dataKey:"y",className:"fill-purple-300 stroke-purple-500"},R={r:8,className:"fill-purple-500"},o=[{x:"Mon",y:0},{x:"Tue",y:30},{x:"Wed",y:20},{x:"Thu",y:60},{x:"Fri",y:27},{x:"Sat",y:40},{x:"Sun",y:30}],H={title:"Visualizations/Chart/AreaChart",component:l,args:{data:o},parameters:{sourceLink:"https://github.com/juneHQ/ui/tree/main/lib/components/AreaChart/index.tsx"}},a={args:{data:o,margin:{top:20,left:10,right:10,bottom:10}},render:d=>e.jsxs(l,{...d,children:[e.jsx(b,{...g}),e.jsx(x,{...L,dataKey:"y"}),e.jsx(u,{...P,dataKey:"x"}),e.jsx(m,{...D,content:({active:t,payload:r,label:p})=>e.jsx(y,{label:p,active:t,payload:r,valueFormatter:c=>`${c.y} count`})}),e.jsx(f,{...T,y:o.sort((t,r)=>r.y-t.y)[0].y,children:e.jsx(h,{content:({viewBox:t})=>e.jsx(v,{viewBox:t,children:"All time high"})})}),e.jsx(A,{...K,activeDot:e.jsx(j,{...R,onClick:()=>{},cursor:"pointer"}),dataKey:"y"}),e.jsx(C,{content:()=>e.jsxs("div",{className:"text-center",children:[e.jsx("div",{children:"x – day"}),e.jsx("div",{children:"y – users"})]})})]})};var s,n,i;a.parameters={...a.parameters,docs:{...(s=a.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    data,
    margin: {
      top: 20,
